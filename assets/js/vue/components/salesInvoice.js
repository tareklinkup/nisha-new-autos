            ...
            <div id="invoiceContent">
                    ...
                    <div class="col-xs-12">
                        <table _a584de>
                            ...
                            <tr>
                                ...
                                <td>{{ cart.reduce((p, c) => { return p + parseFloat(c.SaleDetails_TotalQuantity) }, 0) }}</td>
                                <td colspan="2"></td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                <td><strong>Discount: ({{(parseFloat(sales.SaleMaster_TotalDiscountAmount) / parseFloat(sales.SaleMaster_SubTotalAmount) * 100).toFixed(2)}} %)</strong></td>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <p>আপনার হিসাব মিলিয়ে নিন। বিক্রিত মাল ৭ দিনের পরে ফেরত নেওয়া হয় না।</p>
                    </div>
                </div>
            </div>
        </div>
