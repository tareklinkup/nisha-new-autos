<?php
    class Transfer extends CI_Controller{
        ...
        public function getCashTransfer()
        {
            ...
            $clauses = "";
            if(isset($data->branch_to) && $data->branch_to != ''){
                $clauses .= " and tm.transfer_to = '$data->branch_to'";
            }
        ...
        public function cashTransferReceived()
        {
            ...
            $data['title'] = "Cash Received List";
            $data['content'] = $this->load->view('Administrator/transfer/cash_received_list', $data, true);
            $this->load->view('Administrator/index', $data);
        }
        ...
        public function updateProductTransfer(){
            ...
            try{
                ...
                $oldTransfer = $this->db->query("select * from tbl_transfermaster where transfer_id = ?", $data->transfer->transfer_id)->row();
