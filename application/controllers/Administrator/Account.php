...
class Account extends CI_Controller {
    ...
    public function getCashTransactions(){
        ...
        if(isset($data->transactionType) && $data->transactionType != '' && $data->transactionType == 'vat_paid'){
            $transactionTypeClause = " and ct.Tr_Type = 'Vat Payment'";
        }
    ...
    function getOtherIncomeExpense(){
        ...
        $result = $this->db->query("
            ...
            (
                select ifnull(sum(rd.SaleReturnDetails_ReturnAmount) - sum(sd.averagePurchasePrice * rd.SaleReturnDetails_ReturnQuantity), 0)
