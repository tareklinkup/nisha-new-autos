...
class Employee extends CI_Controller
{
    ...
    public function getEmployeePayments(){
        ...
        $payments = $this->db->query("
            select 
                ...
                ds.Designation_Name,
                m.month_name
            from tbl_employee_payment_old ep
    ...
    public function getSalarySummary(){
        ...
        $summary = $this->db->query("
            select 
                ...
                ds.Designation_Name,
                (
                    select ifnull(sum(ep.payment_amount), 0) from tbl_employee_payment_old ep
                ...
                (
                    select ifnull(sum(ep.deduction_amount), 0) from tbl_employee_payment_old ep
                    where ep.Employee_SlNo = e.Employee_SlNo
                    and ep.status = 'a'
                    and ep.month_id = " . $data->monthId . "
                    and ep.paymentBranch_id = " . $this->session->userdata('BRANCHid') . "
    ...
    public function addEmployeePayment()
    {
        ...
        try{
            ...
            $this->db->insert('tbl_employee_payment_old', $payment);
    ...
    public function updateEmployeePayment()
    {
        ...
        try{
            ...
            $this->db->where('employee_payment_id', $paymentObj->employee_payment_id)->update('tbl_employee_payment_old', $payment);
    ...
    public function deleteEmployeePayment(){
        ...
        try{
            ...
            $this->db->set(['status'=>'d'])->where('employee_payment_id', $data->paymentId)->update('tbl_employee_payment_old');
