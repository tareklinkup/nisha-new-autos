    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
            ...
            <div class="form-group" style="margin-top:10px;" v-if="selectedSearchType.value != 'current'">
                <div class="col-sm-2" style="margin-left:15px;">
                    <input type="date" v-model="date" id="" class="form-control">
                </div>
            </div>
                ...
                <table class="table table-bordered" v-if="searchType != 'current' && searchType != null"
                    ...
                    <tbody>
                        <tr v-for="product in stock">
                            ...
                            <td style="text-align:right;">{{ product.current_quantity }} {{ product.Unit_Name }}</td>
                            <td style="text-align:right;">{{ parseFloat(product.stock_value).toFixed(2) }}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            <td colspan="11" style="text-align:right;">Total Stock Value</td>
                            <td style="text-align:right;">{{ parseFloat(totalStockValue).toFixed(2) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
