...
<div class="row" id="customerDueList">
	...
	<div class="col-md-12" style="display: none" v-bind:style="{display: dues.length > 0 ? '' : 'none'}">
		<br>
		<a href="" style="width:50px;" v-on:click.prevent="print">
			<i class="fa fa-print"></i> Print
		</a> &nbsp;&nbsp;
		<a href="" style="width:50px;" v-on:click.prevent="sendSms">
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr v-for="data in dues">
						<td><input type="checkbox" v-bind:value="data" v-model="recipients"></td>
...
<script>
	...
	new Vue({
		...
		methods:{
			...
			sendSms() {
				let data = this.recipients.map(recipient => {
					return {
                        to: recipient.Customer_Mobile,
                        message: `
Dear ${recipient.Customer_Name},
Your current due amount is tk. ${recipient.dueAmount}
Please pay the due amount as early as possible.
