					...
					<div style="width:50%;border:1px solid black;border-left:none;position:relative;">
						<table class="day-book-table">
							...
							<tbody>
								...
								<template v-if="vatPaid.length > 0">
									<tr>
										<td class="sub-heading">Vat Paid</td>
										<td class="sub-value">{{ totalVatPaid }}</td>
									</tr>
								...
								<template v-if="employeeOldPayments.length > 0">
									<tr>
										<td class="sub-heading">Employee Old Payments</td>
