				...
				<div class="col-xs-6">
					<table class="balancesheet-table">
						...
						<tbody>
							...
							<tr>
								<td>Vat Paid</td>
								<td style="text-align:right;">{{ totalVatPaid | decimal }}</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="text-align:right;">{{ (parseFloat(totalEmployeePayments) + parseFloat(totalEmployeeOldPayments)) | decimal }}</td>
							</tr>
							<tr>
	...
	new Vue({
		...
		methods: {
			async getStatements() {
				...
				await this.getEmployeeOldPayments();
