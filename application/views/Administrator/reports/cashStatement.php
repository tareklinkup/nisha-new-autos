                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: vatPaid.length > 0 ? '' : 'none'}">{{ totalVatPaid | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: employeeOldPayments.length > 0 ? '' : 'none'}">{{ totalEmployeeOldPayments | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
