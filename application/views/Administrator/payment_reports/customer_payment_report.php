			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr v-if="payments.length">
						...
						<th style="text-align:right">{{ payments.reduce((prev, curr) => { return prev + +curr.bill }, 0).toFixed(2) }}</th>
						<th style="text-align:right">{{ payments.reduce((prev, curr) => { return prev + +curr.paid }, 0).toFixed(2) }}</th>
						<th style="text-align:right">{{ payments.reduce((prev, curr) => { return prev + +curr.due }, 0).toFixed(2) }}</th>
						<th style="text-align:right">{{ payments.reduce((prev, curr) => { return prev + +curr.returned }, 0).toFixed(2) }}</th>
						<th style="text-align:right">{{ payments.reduce((prev, curr) => { return prev + +curr.paid_out }, 0).toFixed(2) }}</th>
<!--						<th style="text-align:right">{{ payments.reduce((prev, curr) => { return prev + +curr.balance }, 0).toFixed(2) }}</th>-->
					</tr>
				</tbody>
