...
<ul class="nav nav-list">
    ...
    <li class="">
        ...
        <ul class="submenu">
            ...
            <?php if (array_search("supplierPaymentHistry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>supplierPaymentHistry">
                    <i class="menu-icon fa fa-caret-right"></i>
                    Supplier Payment Histry
                </a>
                <b class="arrow"></b>
            </li>
            <?php endif; ?>
