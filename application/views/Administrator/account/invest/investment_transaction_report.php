        ...
        methods: {
            ...
            async print(){
                ...
                if(this.selectedAccount != null){
                    ...
                    <strong>Mobile: </strong> ${this.selectedAccount.mobile}<br>
                    <strong>Address: </strong> ${this.selectedAccount.address}<br>`;
                }
                ...
                if(this.filter.dateFrom != '' && this.filter.dateTo != ''){
                    dateText = `<br><br>Statement from <strong>${this.filter.dateFrom}</strong> to <strong>${this.filter.dateTo}</strong><br>`;
                }
                let reportContent = `
					<div class="container">
