    ...
    new Vue({
        ...
        methods: {
            ...
            async print(){
                let accountText = '';
                if(this.selectedAccount != null){
                    accountText = `<strong>Account: </strong> ${this.selectedAccount.Acc_Code}<br>`;
                    accountText += `<strong>Name: </strong> ${this.selectedAccount.Acc_Name}<br>`;
                    accountText += `<strong>Mobile: </strong> ${this.selectedAccount.mobile}<br>`;
                    accountText += `<strong>Address: </strong> ${this.selectedAccount.address}<br>`;
                }
                ...
                let reportContent = `
					<div class="container">
						<h4 style="text-align:center">Investment Ledger Report</h4 style="text-align:center">
                        <div class="row">
