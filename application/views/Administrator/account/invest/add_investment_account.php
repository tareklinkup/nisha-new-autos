                    ...
                    <div class="row">
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control" v-model="account.mobile" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" v-model="account.address"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    new Vue({
        ...
        methods: {
            ...
            saveAccount() {
                ...
                if (this.account.mobile.length != 11) {
