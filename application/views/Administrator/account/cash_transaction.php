						...
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								<input type="number" class="form-control" required v-model="transaction.Out_Amount" 
									v-if="transaction.Tr_Type == 'Out Cash' || transaction.Tr_Type == 'Vat Payment' || transaction.Tr_Type == ''"
									v-bind:style="{display: transaction.Tr_Type == 'Out Cash' || transaction.Tr_Type == 'Vat Payment' || transaction.Tr_Type == '' ? '' : 'none'}"
								>
							</div>
						</div>
						<div class="form-group">
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Trans. Type', field: 'Acc_Name', align: 'center' },
