...
<div id="bankTransactionReport">
    <div class="row" style="border-bottom: 1px solid #ccc;margin-bottom: 15px;">
        <div class="col-md-12">
            <form class="form-inline" @submit.prevent="getTransactions();getBankBalance();">
    ...
    <div class="row" style="display:none;" v-bind:style="{display: transactions.length > 0 ? '' : 'none'}">
        ...
        <div class="col-md-12">
            <div class="table-responsive" id="reportContent">
                ...
                <div class="text-right" v-if="selectedAccount != null">
    ...
    new Vue({
        ...
        methods: {
            ...
            getBankBalance() {
                ...
                axios.post('/get_bank_balance', { accountId: this.selectedAccount.account_id })
                .then(res => {
