	...
	<div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'quantity' && suppliers.length > 0 || searchType == 'supplier' ? '' : 'none'}">
	...
	<div class="row" style="margin-top:15px;display:none;" v-bind:style="{display: purchases.length > 0 ? '' : 'none'}">
		...
		<div class="col-md-12">
			<div class="table-responsive" id="reportContent">
				...
				<table 
					class="record-table" 
					v-if="searchType == 'category' || searchType == 'quantity' || searchType=='supplier' "  
					style="display:none;" 
					v-bind:style="{display: searchType == 'category' || searchType == 'quantity' || searchType=='supplier' ? '' : 'none'}"
					>
					<thead>
						<tr>
							<th>Invoice No.</th>
