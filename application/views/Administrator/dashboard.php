		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-10 col-md-offset-1">
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background-color:#165669;" onmouseover="this.style.background = '#20809b'" onmouseout="this.style.background = '#165669'">
						<a href="<?php echo base_url(); ?>module/SalesModule" style="color:white;">
							<div class="logo">
								<i class="fa fa-usd"></i>
							</div>
							<div class="textModule" style="color:white;">
								Sales Module
							</div>
						</a>
					</div>
				...
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background-color:#18563a;" onmouseover="this.style.background = '#289162'" onmouseout="this.style.background = '#18563a'">
						<a href="<?php echo base_url(); ?>module/PurchaseModule" style="color:white;">
							<div class="logo">
				...
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background-color:#6a6a35;" onmouseover="this.style.background = '#95954a'" onmouseout="this.style.background = '#6a6a35'">
						<a href="<?php echo base_url(); ?>module/AccountsModule" style="color:white;">
							<div class="logo">
				...
				<!-- module/HRPayroll -->
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background-color:#934900;" onmouseover="this.style.background = '#df7000'" onmouseout="this.style.background = '#934900'">
						<a href="<?php echo base_url(); ?>module/HRPayroll" style="color:white;">
							<div class="logo">
				...
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background-color:#520d57;" onmouseover="this.style.background = '#891593'" onmouseout="this.style.background = '#520d57'">
						<a href="<?php echo base_url(); ?>module/ReportsModule" style="color:white;">
							<div class="logo">
				...
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background-color:#b6941f;" onmouseover="this.style.background = '#ddb839'" onmouseout="this.style.background = '#b6941f'">
						<a href="<?php echo base_url(); ?>module/Administration" style="color:white;">
							<div class="logo">
				...
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background-color:#412545;" onmouseover="this.style.background = '#794581'" onmouseout="this.style.background = '#412545'">
						<a href="<?php echo base_url(); ?>graph" style="color:white;">
							<div class="logo">
				...
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background-color:#8a0003;" onmouseover="this.style.background = '#ce0005'" onmouseout="this.style.background = '#8a0003'">
