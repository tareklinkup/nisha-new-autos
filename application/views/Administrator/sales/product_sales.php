					...
					<div class="row">
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="Group" class="form-control" v-model="selectedProduct.brand_name" readonly/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="number" placeholder="Qty" step="0.01" class="form-control" v-model="selectedProduct.quantity" ref="quantity" @input="productTotal" required />
									</div>
									<label class="col-sm-3 control-label no-padding-right"> Body Rate </label>
									<div class="col-sm-3">
										<input type="number" placeholder="Body Rate" step="0.01" class="form-control" v-model="selectedProduct.body_rate" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<label class="col-sm-3 control-label no-padding-right"> SL. Price </label>
									<div class="col-sm-3">
						...
						<div class="col-sm-2">
							<div>
								...
								<input type="password" ref="productPurchaseRate" v-model="selectedProduct.averagePurchasePrice" v-on:mousedown="toggleProductPurchaseRate" v-on:mouseup="toggleProductPurchaseRate"  readonly title="Purchase rate (click & hold)" style="font-size:12px;width:100%;text-align: center;">
							</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:15%;color:#000;">Group</th>
							<th style="width:10%;color:#000;">Product Id</th>
					...
					<tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
						...
						<tr>
							...
							<td colspan="4" style="padding-top: 15px;font-size:18px;">{{ sales.subTotal }}</td>
						</tr>
					</tbody>
				</table>
			</div>
...
<script>
	...
	new Vue({
		...
		methods:{
			...
			calculateSalePrice(){
				this.selectedProduct.Product_SellingPrice = (this.selectedProduct.body_rate * this.selectedProduct.saleIn).toFixed(2);
				this.productTotal();
			},
			calculateSaleIn(){
				this.selectedProduct.saleIn = (this.selectedProduct.Product_SellingPrice / this.selectedProduct.body_rate).toFixed(2);
				this.productTotal();
			},
			productTotal(){
